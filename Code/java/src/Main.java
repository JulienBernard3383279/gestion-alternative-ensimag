...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Rendement mensuel arithmétique du marché : "+( sommeMarche/(fin-debut) ));
		System.out.println("Ecart-type mensuel arithmétique du marché : "+( sommeMarcheCarres/(fin-debut) - sommeMarche*sommeMarche/(fin-debut)/(fin-debut) ) );

		// programme
		
		Utils.PortfoliosYields per=null;
